...
function reloaddata() {
    ...
    for (var i = 0; i < checkbox1.length; i++) {
        if (checkbox1[i].type == "checkbox") {
            checkbox1[i].checked = false;
        }
    }
    $.ajax(list_employee).done(function (response) {
        // biodata
        $("#client").val("");
        $("#applicantstatus").val("");
        $("#jobposition").val("");
        ...
        $("#project_position1").val("");
        $("#start_project1").val("");
        $("#end_project1").val("");
        $("#ket_project1").val("");
        $("#project2").val("");
        $("#project_address2").val("");
        $("#project_position2").val("");
        $("#start_project2").val("");
        $("#end_project2").val("");
        $("#ket_project2").val("");
        $("#project3").val("");
        $("#project_address3").val("");
        $("#project_position3").val("");
        $("#start_project3").val("");
        $("#end_project3").val("");
        $("#ket_project3").val("");
        $("#project4").val("");
        $("#project_address4").val("");
        $("#project_position4").val("");
        $("#start_project4").val("");
        $("#end_project4").val("");
        $("#ket_project4").val("");
        $("#project5").val("");
        $("#project_address5").val("");
        $("#project_position5").val("");
        $("#start_project5").val("");
        $("#end_project5").val("");
        $("#ket_project5").val("");
        $("#project6").val("");
        $("#project_address6").val("");
        $("#project_position6").val("");
        $("#start_project6").val("");
        $("#end_project6").val("");
        $("#ket_project6").val("");
        ...
        $("#applicantstatus").empty();
        $("#applicantstatus").append(
            $("<option>", {
                value: "0",
                text: "",
            })
        );
        $.each(response["applicantstatus"]["data"], function (i, item) {
            $("#applicantstatus").append(
                $("<option>", {
                    value: item.id,
                    text: item.name,
        ...
        $.each(response["jobvacancy"]["data"], function (i, item) {
            $("#jobposition").append(
                $("<option>", {
                    value: item.id,
        ...
        $("#statusaddress").empty();
        $("#statusaddress").append(
            $("<option>", {
                value: "0",
                text: "Select Status Address",
            })
        );
        $.each(response["status_address"]["data"], function (i, item) {
            $("#statusaddress").append(
                $("<option>", {
                    value: item.id,
                    text: item.name,
        ...
        $("#lastedu").append(
            $("<option>", {
                value: "0",
                text: "Select Level of Education",
            })
        );
        $.each(response["level_education"]["data"], function (i, item) {
            $("#lastedu").append(
                $("<option>", {
                    value: item.id,
                    text: item.name,
        ...
        $("#employee").append("<thead><tr><th>Name</th><th>Domisili</th><th>Position</th><th>Status</th><th>Action</th></tr></thead>");
        ...
        var table = $("#employee").DataTable({
            ...
            columns: [
                ...
                {
                    data: "jobposition_id.jobposition",
                    defaultContent: ""
                },
                {
                    data: "applicantstatus_id.name",
                    defaultContent: ""
                },
                {
                    data: null,
                    ...
                    render: function (data, type, full, meta) {
                        if (type === "filter") {
                            $("#editEmp" + data.id).empty();
                            $("#editEmp" + data.id).remove();
                            $("#deleteEmp" + data.id).empty();
                            $("#deleteEmp" + data.id).remove();
...
function modalEdit(i) {
    if ($("#editEmp" + i).length) {
        $("#editEmp" + i).modal("show");
        $("#idedit").val(i);
    } else {
        $.ajax({
            type: "POST",
            url: "/api/V1.0/employeedetail",
            async: true,
            crossDomain: true,
            data: {
                cur_user: sessionStorage.getItem("cur_user"),
            ...
            success: function (response) {
                $("body").append(createmodaledit(response["employee"], response["dataform"]));
...
function modalDelete(i) {
    $("#deleteEmp" + i).modal("show");
}

function createmodaledit(data, dataform) {
    var html = '<div class="modal fade" id="editEmp' + data.id + '" tabindex="-1" role="dialog" aria-labelledby="largeModalLabel" aria-hidden="true">';
    html += '<div class="modal-dialog modal-lg" role="document">';
    html += '<div class="modal-content">';
    html += '<div class="modal-header">';
    html += '<h5 class="modal-title">Edit Applicant</h5>';
    ...
    html += '<label class="control-label mb-1">Status</label>';
    html += '<div class="col-12 col-md-9">';
    html += '<select name="applicantstatus" id="applicantstatus' + data.id + '" class="form-control">';
    html += '<option value = "0">Select Status</option>';
    $.each(dataform["applicantstatus"]["data"], function (key, value) {
        selected = "";
        if (value.id == data.applicantstatus_id.id) {
            selected = "selected";
        } else {
            selected = "";
        }
    ...
    html += '<div class="col-6">';
    html += '<div class="form-group">';
    html += '<label class="control-label mb-1">Position</label>';
    html += '<div class="col-12 col-md-9">';
    html += '<select name="jobposition" id="jobposition' + data.id + '" class="form-control">';
    html += '<option value = "0">Select Position</option>';
    $.each(dataform["jobvacancy"]["data"], function (key, value) {
        selected = "";
        if (value.id == data.jobposition.id) {
            selected = "selected";
        } else {
            selected = "";
        }
        html += '<option value="' + value.id + '" ' + selected + ">" + value.jobposition + "</option>";
    });
    html += "</select>";
    html += "</div>";
    html += "</div>";
    ...
    // html += '<div class="col-6">';
    // html += '<div class="form-group">';
    // html += '<label class="control-label mb-1">Password</label>';
    // var password;
    // if (data.password) {
    ...
    //     password = "";
    // }
    // html += '<input type="text" id="password' + data.id + '" class="form-control" value="' + password + '">';
    // html += "</div>";
    // html += "</div>";
    html += "</div>";
    html += "</div>";
    html += '<div class="modal-footer">';
    html += '<button onclick="editEmp(' + data.id + ')" id="submit-button" class="btn btn-info"><i class="fa fa-check-square"></i><span> Save</span></button>';
    ...
    html += "</div>";
    html += '<div class="modal-footer">';
    html += '<button onclick="editCorres(' + data.id + ')" id="submit-button" class="btn btn-info"><i class="fa fa-check-square"></i><span> Save</span></button>';
    html += '<button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-times"></i><span> Cancel</span></button>';
    html += "</div>";
    html += "</div>";
    ...
    html += "<p>Educational Background</p>";
    html += "</div>";
    html += '<div class="table-responsive">';
    html += '<table id="edutable" class="table table-data3">';
    html += "<thead>";
    html += "<tr>";
    html += '<th rowspan="2">Level</th>';
    html += '<th rowspan="2">Institution Name</th>';
    html += '<th rowspan="2">City</th>';
    html += '<th rowspan="2">Majors</th>';
    html += '<th colspan="2">Year</th>';
    html += '<th rowspan="2">Passed/ No</th>';
    html += "</tr>";
    html += "<tr>";
    html += "<th>Start</th>";
    html += "<th>End</th>";
    ...
    html += "</div>";
    html += '<div class="bordertop">';
    html += "<p>Non-Formal Education</p>";
    html += "</div>";
    html += '<div class="table-responsive">';
    html += '<table id="trainingtable" class="table table-data3">';
    html += "<thead>";
    html += "<tr>";
    html += "<th>Field</th>";
    html += "<th>Institution</th>";
    html += "<th>City</th>";
    html += "<th>Course Length</th>";
    html += "<th>Year</th>";
    html += "<th>Financed by</th>";
    html += "</tr>";
    html += "</thead>";
    html += "<tbody>";
    html += "<tr>";
    ...
    html += "</div>";
    html += '<div class="modal-footer">';
    html += '<button onclick="editEdu(' + data.id + ')" id="submit-button" class="btn btn-info"><i class="fa fa-check-square"></i><span> Save</span></button>';
    html += '<button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-times"></i><span> Cancel</span></button>';
    html += "</div>";
    html += "</div>";
    ...
    html += "</div>";
    html += '<div class="bordertop">';
    html += "<p>Sertifikat Keahlian Kerja (SKA)</p>";
    html += "</div>";
    html += '<div class="table-responsive">';
    html += '<table id="skatable" class="table table-data3">';
    html += "<thead>";
    html += "<tr>";
    html += '<th rowspan="2">Professional Association Members</th>';
    html += '<th rowspan="2">TA Clasification</th>';
    html += '<th rowspan="2">No. SKA</th>';
    html += '<th colspan="2">SKA Validity Period</th>';
    html += "</tr>";
    html += "<tr>";
    html += "<th>Start</th>";
    html += "<th>End</th>";
    ...
    html += "</div>";
    html += '<div class="table-responsive">';
    html += '<table id="worktable" class="table table-data3">';
    html += "<thead>";
    html += "<tr>";
    html += '<th rowspan="2">Company</th>';
    html += '<th rowspan="2">Address</th>';
    html += '<th rowspan="2">Position</th>';
    html += '<th colspan="2">Period</th>';
    html += '<th rowspan="2">Info</th>';
    html += "</tr>";
    html += "<tr>";
    html += "<th>Start</th>";
    html += "<th>End</th>";
    ...
    html += "</div>";
    html += '<div class="bordertop">';
    html += "<p>Project Experience (PT.ESTI YASAGAMA)</p>";
    html += "</div>";
    html += '<div class="table-responsive">';
    html += '<table id="projecttable" class="table table-data3">';
    html += "<thead>";
    html += "<tr>";
    html += '<th rowspan="2">Project</th>';
    html += '<th rowspan="2">Location</th>';
    html += '<th rowspan="2">Position</th>';
    html += '<th colspan="2">Period</th>';
    html += '<th rowspan="2">Info</th>';
    html += "</tr>";
    ...
    html += "</div>";
    html += '<div class="modal-footer">';
    html += '<button onclick="editJob(' + data.id + ')" id="submit-button" class="btn btn-info"><i class="fa fa-check-square"></i><span> Save</span></button>';
    html += '<button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-times"></i><span> Cancel</span></button>';
    html += "</div>";
    html += "</div>";
    ...
    html += '</div>';
    html += '<div class="modal-footer">';
    html += '<button onclick="editFile(' + data.id + ')" id="submit-button" class="btn btn-info"><i class="fa fa-check-square"></i><span> Save</span></button>';
    html += '<button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-times"></i><span> Cancel</span></button>';
    html += '</div>';
    html += '</div>';
    html += "</div>";
...
function createmodaldelete(data) {
    var html = '<div class="modal fade" id="deleteEmp' + data.id + '" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">';
    ...
    html += '<div class="modal-footer">';
    html += "<div>";
    html += '<button id="delete" onclick="DeleteEmp(' + data.id + ')" class="btn btn-info">';
...
function addEmp() {
    ...
    if ($("#applicantstatus").val() == "0") {
        $("#applicantstatus").focus();
        alert("Applicant Status not filled");
        valid = false;
    } else {
        applicantstatus = $("#applicantstatus").val();
        form.append("applicantstatus_id", applicantstatus);
        valid = true;
    }
    if ($("#jobposition").val() == "") {
        $("#jobposition").focus();
        alert("Job position not filled");
        valid = false;
    } else {
        jobposition = $("#jobposition").val();
        form.append("jobposition_id", jobposition);
        valid = true;
    }
    if ($("#name").val() == "") {
        $("#name").focus();
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response["status"] == "400") {
                    ...
                    $("#addid").val(response.user_id);
                    $("#nav-correspondance-tab").removeClass("disabled");
                    alert("New Applicant Successfully Added");
                }
            },
        });
    }
...
function addCorres() {
    ...
    form.append("token", sessionStorage.getItem("token"));
    addid = $("#addid").val();
    form.append("user_id", addid);
    if (valid == true) {
        $.ajax({
            type: "POST",
            url: "/api/V1.0/insertcorespon",
            async: true,
            crossDomain: true,
            data: form,
            processData: false,
            ...
            success: function (response) {
                if (response["status"] == "400") {
                    ...
                    $("#nav-edu-tab").removeClass("disabled");
                    alert("Correspondance Address Successfully Added");
                }
            },
        });
    }
...
function addEdu() {
    ...
    if ($("#lastedu").val() == "0") {
        $("#lastedu").focus();
        alert("Last Education not filled");
        valid = false;
    } else {
        lastedu = $("#lastedu").val();
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response["status"] == "400") {
                    ...
                    $("#nav-work-tab").removeClass("disabled");
                    alert("Educational Background Successfully Added");
                }
            },
        });
    }
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response["status"] == "400") {
                    ...
                    $("#nav-file-tab").removeClass("disabled");
...
function addFile() {
    ...
    valid = true;
    profile = $("#profile").val();
    var pictureInput = document.getElementById("profile").files[0];
    form.append("imgfile", pictureInput);
    fotoktp = $("#fotoktp").val();
    var pictureInput = document.getElementById("fotoktp").files[0];
    form.append("fotoktp", pictureInput);
    fotonpwp = $("#fotonpwp").val();
    var pictureInput = document.getElementById("fotonpwp").files[0];
    form.append("fotonpwp", pictureInput);
    imgcv = $("#cv").val();
    var pictureInput = document.getElementById("cv").files[0];
...
function editEmp(i) {
    ...
    if ($("#applicantstatus" + i).val() == "0") {
        $("#applicantstatus" + i).focus();
        alert("Applicant Status not filled in");
        valid = false;
    } else {
        applicantstatus = $("#applicantstatus" + i).val();
        form.append("applicantstatus_id", applicantstatus);
        valid = true;
    }
    if ($("#jobposition" + i).val() == "") {
        $("#jobposition" + i).focus();
        alert("Job Position not filled in");
        valid = false;
    } else {
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response["status"] == "400") {
                    ...
                    alert("Correspondance Address Successfully Edited");
                    $("#editEmp").modal("hide");
                    $(".modal-backdrop.fade.show").remove();
                    reloaddata();
                }
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response["status"] == "400") {
                    ...
                    alert("Educational Background Successfully Edited");
                    $("#editEmp").modal("hide");
                    $(".modal-backdrop.fade.show").remove();
                    reloaddata();
                }
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response["status"] == "400") {
                    ...
                    alert("Working Experience Successfully Edited");
                    $("#editEmp" + i).modal("hide");
                    $(".modal-backdrop.fade.show").remove();
                    reloaddata();
                }
            },
...
function fillattachment(data) {
    ...
    $.ajax({
        async: true,
        crossDomain: true,
        url: "/images/" + data.profile_picture.name,
        method: "POST",
        processData: false,
        contentType: false,
        datatype: "JSON",
        ...
        success: function (response) {
            $("#ppicture" + data.id).html(
                '<label for="images" class="control-label mb-1">Foto Profil</label><br/><img src="data:image/jpeg;base64,' +
                    response +
                    '" style="width: 213px; height: 213px;"/><input type="file" name="profile" id="profile' +
                    data.id +
                    '" class="form-control"/><input type="hidden" id="picid' +
                    data.id +
                    '" value="' +
        ...
        success: function (response) {
            $("#ktphoto" + data.id).html(
                '<label for="images" class="control-label mb-1">KTP</label><br/><img src="data:image/jpeg;base64,' +
                    response +
                    '" style="width: 213px; height: 213px;"/><input type="file" name="fotoktp" id="fotoktp' +
                    data.id +
                    '" class="form-control"/><input type="hidden" id="ktpid' +
                    data.id +
                    '" value="' +
                    data.fotoktp.id +
                    '"><p class="small">Max upload file: 2MB</p>'
        ...
        success: function (response) {
            $("#npwphoto" + data.id).html(
                '<label for="images" class="control-label mb-1">NPWP</label><br/><img src="data:image/jpeg;base64,' +
                    response +
                    '" style="width: 213px; height: 213px;"/><input type="file" name="fotonpwp" id="fotonpwp' +
                    data.id +
                    '" class="form-control"/><input type="hidden" id="npwpid' +
                    data.id +
                    '" value="' +
                    data.fotonpwp.id +
                    '"><p class="small">Max upload file: 2MB</p>'
    ...
    if (data.cv.id) {
        $("#photocv" + data.id).html(
            '<label class="control-label mb-1">Curriculum Vitae</label><input type="file" name="cv" id="cv' +
                data.id +
                '" class="form-control"/><a href="javascript:getcv(' +
                data.cv.id +
                "," +
                data.id +
                ');" >' +
                data.cv.name +
                '</a><input type="hidden" id="cvid' +
                data.id +
                '" value="' +
                data.cv.id +
                '"><p class="small">Jenis file: PDF, DOC, DOCX. Max: 5MB</p>'
        );
    } else {
